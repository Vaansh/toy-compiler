...
test_src_paths = [
    test_src_path
    for test_src_path in os.listdir("tests/generation_test/cases/")
    if test_src_path != ".DS_Store"
]


def generation_test() -> None:
    """Main test function."""
...
def file_path(t: str) -> str:
    """Returns file path."""
    return "tests/generation_test/cases/" + t


def tree_output_path(t: str) -> str:
    """Returns output path."""
    return "tests/generation_test/results/" + t.split(".")[0] + ".outast"


def sym_tab_output_path(t: str) -> str:
    """Returns output path."""
    return "tests/generation_test/results/" + t.split(".")[0] + ".outsymboltable"


def code_gen_output_path(t: str) -> str:
    """Returns output path."""
    return "tests/generation_test/results/" + t.split(".")[0] + ".moon"


def output_path(t: str) -> str:
    """Returns output path."""
    return "tests/generation_test/results/" + t.split(".")[0] + ".outderivation"


def error_path(t: str) -> str:
    """Returns error path."""
    return "tests/generation_test/errors/" + t.split(".")[0] + ".outsyntaxerrors"


def lex_output_path(t: str) -> str:
    """Returns output path."""
    return "tests/generation_test/results/" + t.split(".")[0] + ".outlextokens"


def lex_err_path(t: str) -> str:
    """Returns error path."""
    return "tests/generation_test/errors/" + t.split(".")[0] + ".outlexerrors"


def sem_err_path(t: str) -> str:
    """Returns error path."""
    return "tests/generation_test/errors/" + t.split(".")[0] + ".outsemanticerrors"
...
def gen_driver(
    ...
    print("\nPerforming code generation for source code file at: {0}".format(file_path))
    ...
    print(
        "Moon file for {0} stored at: {1}".format(file_path, code_gen_output_path + " ")
    )
